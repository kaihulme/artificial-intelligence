...
%% is directly contained in which other doll. Then, define arecursive predicate 
%% in/2 , that tells us which doll is (directly or indirectly) contained in 
%% which other dolls. For example, the query in(katarina,natasha) should
%% evaluate to true, while in(olga, katarina) should fail.
